...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/bd518114417f42329e83c87414b4b914
  NOTION_PAGE_ID:
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'soft阿华', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://softahua.com', // 网站地址
